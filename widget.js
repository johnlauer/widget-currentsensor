...
cprequire_test(["inline:net-mydomain-widget-currentsensor"], function(myWidget) {
...
cpdefine("inline:net-mydomain-widget-currentsensor", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-mydomain-widget-currentsensor", // Make the id the same as the cpdefine id
        name: "Widget / Current Sensor", // The descriptive name of your widget.
        desc: "This widget will show you a real-time graph of a current sensor.", // A description of what your widget does
